...
public abstract class BasicTestSet extends DefaultTestSet {
	...
	protected UploadImageMainPage uploadImageMainPage;
	protected StackOverFlowMainPage stackOverFlowMainPage;
	protected TestingMainPage testingMainPage;
	protected TestingWebMainPage testingWebMainPage;
	protected TestingAlertsMainPage testingAlertsMainPage;
	protected TestingSliderMainPage testingSliderMainPage;
	protected JQueryMainPage jQueryMainPage;
	protected JQueryControlGroupMainPage jQueryControlGroupMainPage;
	protected JQuerySelectMenu jQuerySelectMenu;
	protected CheckBoxMainPage checkBoxMainPage;
